...
namespace WebBff.Handlers
{
    public class BasicAuthenticationHandler(
        ...
        UrlEncoder encoder,
        IOptionsSnapshot<BasicAuthenticationOptions> BasicAuthenticationOptions) : AuthenticationHandler<AuthenticationSchemeOptions>(options, logger, encoder)
    {
        ...
        private BasicAuthenticationOptions SetOptions()
            => Scheme.Name switch
            {
                "BasicAuthentication" => BasicAuthenticationOptions.Value,
